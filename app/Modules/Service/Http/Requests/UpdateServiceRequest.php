...
class UpdateServiceRequest extends FormRequest
{
    ...
    {
        return [
            'title.required' => 'Judul service harus diisi',
            'title.max' => 'Judul service maksimal 255 karakter',
            'content.required' => 'Konten service harus diisi',
