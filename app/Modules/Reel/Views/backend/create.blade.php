...
<div class="space-y-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Tambah Reel</h1>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
        <form action="{{ route('reels.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="url" name="reel_url" value="{{ old('reel_url') }}" required
            ...
            <div>
                ...
                <input type="text" name="reel_judul" value="{{ old('reel_judul') }}"
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Upload screenshot/thumbnail dari reel. Format: JPG, PNG. Maks 2MB.</p>
                @error('reel_thumbnail') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                <div id="preview-wrapper" class="hidden mt-3">
                    <img id="preview" src="#" alt="Preview" class="h-48 w-auto rounded-xl border border-gray-200 object-cover">
                </div>
            </div>
