                    ...
                    <article class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold mb-2 line-clamp-2">
                                <a href="{{ route('frontend.blog.show', $post->posts_slug) }}" class="hover:text-blue-600 transition-colors">
                                    {{ $post->posts_judul }}
                                </a>
                            </h3>
                            ...
                            <p class="text-gray-600 mb-4 line-clamp-3">
                                {{ Str::limit(strip_tags($post->posts_deskripsi ?: $post->posts_konten), 150) }}
                            </p>

                            <!-- Read More Link -->
                            <a
                                href="{{ route('frontend.blog.show', $post->posts_slug) }}"
