...
namespace App\Modules\OurClient\Http\Requests;
...
class StoreOurClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'unique:ourclient'],
    ...
    {
        return [
            'title.required' => 'Judul ourclient harus diisi',
            'title.max' => 'Judul ourclient maksimal 255 karakter',
            'content.required' => 'Konten ourclient harus diisi',
