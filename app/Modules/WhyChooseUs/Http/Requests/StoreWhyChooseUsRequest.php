...
namespace App\Modules\WhyChooseUs\Http\Requests;
...
class StoreWhyChooseUsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'unique:whychooseus'],
    ...
    {
        return [
            'title.required' => 'Judul whychooseus harus diisi',
            'title.max' => 'Judul whychooseus maksimal 255 karakter',
            'content.required' => 'Konten whychooseus harus diisi',
