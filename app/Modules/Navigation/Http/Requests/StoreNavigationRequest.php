...
class StoreNavigationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'unique:navigations'],
    ...
    {
        return [
            'title.required' => 'Judul navigation harus diisi',
            'title.max' => 'Judul navigation maksimal 255 karakter',
            'content.required' => 'Konten navigation harus diisi',
