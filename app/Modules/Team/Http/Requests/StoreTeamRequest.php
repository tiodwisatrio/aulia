...
class StoreTeamRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'unique:teams'],
    ...
    {
        return [
            'title.required' => 'Judul team harus diisi',
            'title.max' => 'Judul team maksimal 255 karakter',
            'content.required' => 'Konten team harus diisi',
