...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage events and agendas for your institution</p>
        </div>
        <a href="{{ route('ourclients.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $ourclients->count() }}</p>
                </div>
            </div>
        </div>
    ...
    <!-- Agenda Table (same structure as OurClient) -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-3">
                                ...
                                <form action="{{ route('agendas.destroy', $agenda) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this agenda?')" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-600 hover:text-red-900 transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  ...
                                                  7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1
                                                  1v3M4 7h16"/>
                                        </svg>
                                    </button>
                                </form>
        ...
        <div class="px-6 py-12 text-center">
            ...
            <p class="mt-2 text-gray-500">Start managing agendas by adding your first item.</p>
            <div class="mt-6">
                <a href="{{ route('agendas.create') }}"
                   class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg inline-flex items-center transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
