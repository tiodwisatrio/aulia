...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Our Clients Card -->
        <a href="{{ route('ourclients.index') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow block">
            <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('contacts.index') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow block">
            <div class="flex items-center justify-between mb-4">
                ...
                @php
                    $newMessages = \App\Modules\Contact\Models\ContactMessage::where('status', 'new')->count();
                @endphp
                @if($newMessages > 0)
        ...
        <a href="{{ route('testimonials.index') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow block">
            ...
            <p class="text-3xl font-bold text-gray-900">{{ \App\Modules\Testimonial\Models\Testimonial::count() }}</p>
        </a>
    </div>
